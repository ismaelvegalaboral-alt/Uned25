...
FEATURE_PATHS = [
    ...
    ('/parte-personal/', 'daily_reports'),
    ('/partes-personales/', 'daily_reports'),
    ('/daily-reports/', 'daily_reports'),
    ('/albaranes/', 'customer_delivery_notes'),
    ('/albaran/', 'customer_delivery_notes'),
    ('/albaranes-cliente/', 'customer_delivery_notes'),
    ('/customer-delivery-notes/', 'customer_delivery_notes'),
    ('/faena/', 'daily_jobs'),
    ('/mi-faena/', 'daily_jobs'),
    ('/ordenes-trabajo/', 'work_orders'),
    ('/ordenes/', 'work_orders'),
    ('/ordenes-de-trabajo/', 'work_orders'),
...
def can_use_feature(user, feature):
    ...
    try:
        ...
        return True
    return bool(getattr(permissions, f'can_use_{feature}', True))
