...
MIDDLEWARE = [
    ...
    'vacations.feature_access.FeatureAccessMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'vacations.context_processors.feature_flags',
...
DAILY_REPORT_RECIPIENT_EMAILS = os.getenv('DAILY_REPORT_RECIPIENT_EMAILS', '')

# Albaranes de cliente
CUSTOMER_DELIVERY_NOTE_RECIPIENT_EMAILS = os.getenv('CUSTOMER_DELIVERY_NOTE_RECIPIENT_EMAILS', '')
